...
export default function Home() {
  ...
  return (
    <div className="mobile:w-full w-full bg-[#282c34] flex flex-col justify-center items-center">
      ...
      <div className="bg-uvodHomeBg mobile:h-[100vh] mobile:w-full w-[90%] bg-cover bg-no-repeat bg-[50%_15%]">
        {' '}
        <h1
          className="mobile:text-[2.5rem] z-100 pt-[30px] !opacity-100 text-black font-extralight text-[3.5rem] font-pacifico text-center"
          lang="sr-Cyrl"
        >
        ...
        <p
          lang="sr-Cyrl"
          className="mobile:text-[1.2rem] mob font-pacifico text-black text-[2rem] text-center"
        >
          -{t('po_narudzbini')}-
        </p>
          ...
          <ul className="mobile:pt-0 flex mobile:flex-col flex-wrap w-[70%] mobile:w-full">
            {
              navList?.map((a,i)=>{
                return(
            <li className="mobile:m-0 mobile:p-0 mobile:text-[18px] text-center  list-style-none pt-[30px] flex flex-col justify-around text-[2rem] mobile:w-full w-[50%]">
              <a
