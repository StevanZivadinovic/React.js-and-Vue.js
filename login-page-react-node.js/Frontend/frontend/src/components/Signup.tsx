    ...
    <div className="bg-white p-3 rounded w-25">
        ...
        <form action="" onSubmit={handleSubmit}>
            <div className="mb-3">
                ...
                <input name='name' onChange={(event)=>{handleInput(event)}} type="text" placeholder='Enter name' className='form-control rounded-0' />
            ...
            <Link to='/' className='btn btn-default border bg-light w-100'>Log in</Link>
        </form>
    </div>
</div>
  )
