    ...
    <div className=' w-full h-[600px] px-4 py-28 z-[1150] fixed'>
        <div className="max-w-[450px] h-[600px] mx-auto bg-black/75 text-white ">
            <div className="max-w-[320px] py-[52px] m-auto">
                ...
                <button className='bg-red-600 text-3xl rounded my-5 py-5 font-bold'>Sign In</button>
                ...
                <div>
                    <p className='mt-10 text-gray-500 text-3xl flex justify-between'>New to Netflix?
                    <Link to='/signup'>
                     <span className='ml-2 text-3xl text-gray-100 font-bold cursor-pointer'>Sign up</span>
                     </Link>
                     </p>
                </div>
